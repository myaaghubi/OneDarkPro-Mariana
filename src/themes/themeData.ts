...
export default {
  ...
  editorThemes: {
    ...
    'One Dark Pro': () => import('./data/oneDarkProMariana'),
    'One Dark Pro Flat': () => import('./data/oneDarkProFlatMariana'),
    'One Dark Pro Darker': () => import('./data/oneDarkProDarkerMariana'),
    'One Dark Pro Mix': () => import('./data/oneDarkProMixMariana'),
